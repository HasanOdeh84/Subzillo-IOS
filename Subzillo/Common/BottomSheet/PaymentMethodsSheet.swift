...
struct PaymentMethodsSheet: View {
    ...
    var paymentMethodResponse               : [PaymentMethod]?
    var header                              : String?
    ...
    var filteredPaymentMethods: [PaymentMethod] {
        ...
        return paymentMethodResponse?.filter {
    ...
    var body: some View {
        VStack {
            ...
            if filteredPaymentMethods.count != 0{
                VStack(spacing: 0){
                    List(filteredPaymentMethods, id: \.self) { category in
...
#Preview {
    PaymentMethodsSheet(selectedPaymentMethod: .constant(nil))
}

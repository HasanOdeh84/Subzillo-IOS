...
@objc public class ULink: NSObject {
    ...
    /**
     * Synchronously configures the SDK instance to prevent crashes on early access.
     * Use this in didFinishLaunchingWithOptions before starting the asynchronous initialization.
     */
    @objc public static func configure(config: ULinkConfig) {
        if _instance == nil {

...
//    static let dashClr                  = Color(hex: "#CCCCCC")
//    
...
//    static let neutralDisabled200White  = Color(hex: "#F8FAFC")
...
//    static let secondaryNavyBlue800     = Color(hex: "#102844")
...
//    static let grayP                    = Color(hex: "#6A6A6A")
    ...
    static func safeHex(_ hex: String) -> Color {
